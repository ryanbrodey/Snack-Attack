...
public class KiwiAnimationReceiver : MonoBehaviour
{
    [Header("Attack Settings")]
    public int damage = 10;
    public float hitRadius = 1.2f;
    public Transform attackPoint;   // empty child positioned at the kiwi's "mouth" or front
